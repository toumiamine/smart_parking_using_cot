...
class ListReservations1 extends StatefulWidget {
  ...
  @override
  State<ListReservations1> createState() => _ListReservations1State();
}

class _ListReservations1State extends State<ListReservations1> {
                                                                                    ...
                                                                                    return AlertDialog(
                                                                                        ...
                                                                                        content: Container(
                                                                                          ...
                                                                                          child: Column(
                                                                                            children: [
                                                                                              Text(
                                                                                                  "Are you sure want to delete '${Res[index1]
                                                                                                      .id}' reservation created by ${Res[index1]
                                                                                                      .user_id}?"),
                                                                                              SizedBox(
                                                                                                height: 16,
                                                                                              ),
